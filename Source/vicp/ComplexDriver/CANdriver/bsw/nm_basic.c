...
|                              ESCAN00011994: no changes in this file
...
|                              ESCAN00012670: no changes in this file
...
|                              ESCAN00012906: no changes in this file
...
|                              ESCAN00013016: no changes in this file
...
| 2013-05-21   1.16.00 vismpf  ESCAN00066190: no changes in this file
...
|                              ESCAN00067678: no changes in this file
|                              ESCAN00067823: Added own NmBasicCanOnlineOffline defines
| 2015-02-02   1.17.00 vismpf  ESCAN00074418: extended encapsulation with C_CLIENT_BMWAG
|                              ESCAN00081008: Removed pre-compile checks of timing parameters
| 2015-10-07   1.18.00 vismpf  ESCAN00085715: no changes in this file
...
|                              ESCAN00086247: Generated Timing Values are divided by task cycle time
...
* version control
****************************************************************************/
#if( NM_PWRTRAINBASIC_VERSION != 0x0119 )
# error "Header and source file are inconsistent!"
#endif
#if( NM_PWRTRAINBASIC_RELEASE_VERSION != 0x01 )
...
# if defined(NMBASIC_ENABLE_INDEXED_NM)   /* ESCAN00012094 */
# else
...
/* check if either 'immediate' or 'delayed' or 'extended' or 'time supervised' or 'three-step' BusOff recovery algorithm is activated */
/* ESCAN00017908: added check for algo 'time supervised'  */
   ...
   || defined( NMBASIC_BUSOFF_RECOV_EXTENDED ) || defined( NMBASIC_BUSOFF_RECOV_TIME_SUPERVISED ) \
   || defined( NMBASIC_BUSOFF_RECOV_THREE_STEP ) )
#else
# error "no valid configuration of the BusOff algorithm - neither 'immediate' nor 'delayed' nor 'extended' nor 'time supervised' nor 'three-step' algo is specified"
...
#if( defined(NMBASIC_BUSOFF_RECOV_DELAYED) && defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
# error "more than one BusOff algorithm configured - 'delayed' and 'three-step' at the same time"
# error "please check configuration in generation tool and/or the configuration file"
#endif
...
# error "more than one BusOff algorithm configured - 'extended' and 'three-step' at the same time"
# error "please check configuration in generation tool and/or the configuration file"
#endif
...
#if( defined(NMBASIC_BUSOFF_RECOV_TIME_SUPERVISED) && defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
# error "more than one BusOff algorithm configured - 'time supervised' and 'three-step' at the same time"
# error "please check configuration in generation tool and/or the configuration file"
#endif

#if( defined(NMBASIC_BUSOFF_RECOV_IMMEDIAT) && defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
# error "more than one BusOff algorithm configured - 'immediate' and 'three-step' at the same time"
# error "please check configuration in generation tool and/or the configuration file"
#endif
...
#if(defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) && defined (VGEN_CANGEN_VERSION) )
# error "BusOff recovery algorithm 'three-step' is not supported in CANgen"
# error "please check configuration in generation tool and/or the configuration file"
#endif
...
/* only if the 'three-step' BusOff algorithm is activated */
#if( defined NMBASIC_BUSOFF_RECOV_THREE_STEP )
/* check if the BusOff repair mechanism via message Tx is disabled */
# if( defined(NMBASIC_ENABLE_BUSOFFREP_MSG) )
#  error "The BusOff repair mechanism via message Tx must not be enabled if 'three-step' BusOff recovery is used."
#  error "please check configuration in generation tool and/or the configuration file"
# endif
...
# if( defined(NMBASIC_ENABLE_BUSOFFREP_TIMER) )
# else
#  error "The BusOff repair mechanism via timer must be enabled if 'three-step' BusOff recovery is used."
#  error "please check configuration in generation tool and/or the configuration file"
# endif
...
# if ( defined ( NMBASIC_BUSOFF_RECOV_DELAYED ) ) || ( defined ( NMBASIC_BUSOFF_RECOV_EXTENDED ) ) || \
     ( defined ( NMBASIC_BUSOFF_RECOV_THREE_STEP ) ) || ( defined ( NMBASIC_BUSOFF_RECOV_TIME_SUPERVISED ) )
...
#  define cNmBasicBusOffRecSlowTimer ( NmBasicBusOffRecTimeSlow_Field[channel] )
# endif

# if defined(NMBASIC_BUSOFF_RECOV_EXTENDED)
#  define cNmBasicBusOffFastToSlowTimer ( NmBasicBusOffFastToSlow_Field[channel] )
# endif

# if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
#  define cNmBasicBusOffImmediateToQuickCnt  ( NmBasicBusOffImmediateToQuickCnt_Field[channel] )
#  define cNmBasicBusOffQuickToSlowCnt       ( NmBasicBusOffQuickToSlowCnt_Field[channel] )
#  define cNmBasicBusOffRecImmediateTimer    ( NmBasicBusOffRecTimeImmediate_Field[channel] )
# endif

# if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
/* time distance between detected BusOff event and a detection of BusOff repaired */
#  define cNmBasicBusOffRepairedTimer ( NmBasicBusOffRepairedTime_Field[channel] )
# endif
...
# if( defined(NMBASIC_BUSOFF_RECOV_EXTENDED) || defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
/* time distance between HW BusOff event and SW BusOff recovery for slow recovery */
#  define cNmBasicBusOffRecSlowTimer ( cNmBasicBusOffRecTimeSlow )
# endif

# if defined(NMBASIC_BUSOFF_RECOV_EXTENDED)
#  define cNmBasicBusOffFastToSlowTimer ( cNmBasicBusOffChangeFastToSlow )
# endif

# if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
#  define cNmBasicBusOffRecImmediateTimer    ( cNmBasicBusOffRecTimeImmediate )
# endif

# if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
/* time distance between detected BusOff event and a detection of BusOff repaired */
#  define cNmBasicBusOffRepairedTimer ( cNmBasicBusOffRepairedTime )
# endif
...
/* ESCAN00031157 */ /* ESCAN00067823 */
# define NmBasicCanOnline              ApplNmBasicCanOnline
# define NmBasicCanOffline             ApplNmBasicCanOffline
#else
# define NmBasicCanOnline              CanOnline
# define NmBasicCanOffline             CanOffline
#endif
...
#  define NmBasicAssert(p, e)       {if(!(p)){ApplNmBasicFatalError(channel, (e));}}  /* PRQA S 3458 */ /* MD_CBD_19.4 */
#  define NmBasicAssertAlways(e)   {ApplNmBasicFatalError(channel, (e));}  /* PRQA S 3458 */ /* MD_CBD_19.4 */
# else
/* assertions are enabled in single channel system */
#  define NmBasicAssert(p, e)       {if(!(p)){ApplNmBasicFatalError((e));}}  /* PRQA S 3458 */ /* MD_CBD_19.4 */
#  define NmBasicAssertAlways(e)   {ApplNmBasicFatalError((e));}  /* PRQA S 3458 */ /* MD_CBD_19.4 */
# endif
#else
...
#if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
# if ( defined NMBASIC_ENABLE_INDEXED_NM )
static vuint8 bNmBasicBusOffImmediateToQuickCnt[cNmBasicNrOfChannels];
static vuint8 bNmBasicBusOffQuickToSlowCnt[cNmBasicNrOfChannels];
# else
static vuint8 bNmBasicBusOffImmediateToQuickCnt;
static vuint8 bNmBasicBusOffQuickToSlowCnt;
# endif
#endif
...
static vuint16 wNmBasicBusOffRecFastSlowTimer[cNmBasicNrOfChannels];
...
# else
/* time distance between changing from fast to slow BusOff recovery */
static vuint16 wNmBasicBusOffRecFastSlowTimer;
...
#if ( defined(NMBASIC_BUSOFF_RECOV_EXTENDED) && defined(NMBASIC_ENABLE_BUSOFFREP_TIMER) || defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
# if ( defined NMBASIC_ENABLE_INDEXED_NM )
/* time distance to detect a repaired BusOff */
static vuint16 wNmBasicBusOffRepairedTimer[cNmBasicNrOfChannels];
# else
/* time distance to detect a repaired BusOff */
static vuint16 wNmBasicBusOffRepairedTimer;
# endif
#endif
...
*  The message is suppressed because the re-definition is intended and not done by mistake. */
#if( defined NMBASIC_ENABLE_INDEXED_NM )
...
# endif
# if defined(NMBASIC_BUSOFF_RECOV_EXTENDED)
#  define wNmBasicBusOffRecFastSlowTimer    wNmBasicBusOffRecFastSlowTimer[channel]
...
# endif
# if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
#  define bNmBasicBusOffImmediateToQuickCnt bNmBasicBusOffImmediateToQuickCnt[channel]
#  define bNmBasicBusOffQuickToSlowCnt      bNmBasicBusOffQuickToSlowCnt[channel]
# endif
# if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
#  define wNmBasicBusOffRepairedTimer       wNmBasicBusOffRepairedTimer[channel]
# endif
...
#  if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
  ...
  if ( wNmBasicBusOffRepairedTimer != 0u )
  {
    wNmBasicBusOffRepairedTimer = 0u;
...
#  endif
  ...
  wNmBasicBusOffRecFastSlowTimer = 0u;
...
# if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
  bNmBasicBusOffImmediateToQuickCnt = 0u;
  bNmBasicBusOffQuickToSlowCnt = 0u;
# endif
...
# endif
  ...
  NmBasicCanOffline(NMBASIC_CHANNEL_CANPARA_ONLY);
...
# if( defined(NMBASIC_BUSOFF_RECOV_DELAYED) || defined(NMBASIC_BUSOFF_RECOV_EXTENDED) || defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
    NmBasicAssert( ( (cNmBasicBusOffRecTimer > 0) && (cNmBasicBusOffRecTimer <= 65535) ), kNmBasicErrBusOffFastTimeOutOfRange)
# endif

# if( defined(NMBASIC_BUSOFF_RECOV_EXTENDED) || defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
    NmBasicAssert( ( (cNmBasicBusOffRecSlowTimer > 0) && (cNmBasicBusOffRecSlowTimer <= 65535) ), kNmBasicErrBusOffSlowTimeOutOfRange)
#  if defined(NMBASIC_BUSOFF_RECOV_EXTENDED)
    NmBasicAssert( ( (cNmBasicBusOffFastToSlowTimer > 0) && (cNmBasicBusOffFastToSlowTimer <= 65535) ), kNmBasicErrBusOffFastSlowTimeOutOfRange)
    NmBasicAssert( ( (cNmBasicBusOffRecTimer <= cNmBasicBusOffRecSlowTimer) ), kNmBasicErrFastLargerSlowTime)
#  endif
#  if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
    NmBasicAssert( ( (cNmBasicBusOffRecImmediateTimer > 0) && (cNmBasicBusOffRecImmediateTimer <= 65535) ), kNmBasicErrBusOffImmediateTimeOutOfRange)
#  endif
#  if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
    NmBasicAssert( ( (cNmBasicBusOffRepairedTimer > 0) && (cNmBasicBusOffRepairedTimer <= 65535)), kNmBasicErrBusOffRepTimeOutOfRange)
#   if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
#   else
...
#    if defined ( V_ENABLE_USE_DUMMY_STATEMENT )
  (void)channel;  /* PRQA S 3112 */ /* MD_NmBasic_3112 */
#    endif
#  endif
#endif
...
# if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
    ...
    wNmBasicBusOffRepairedTimer = (vuint16)(cNmBasicBusOffRepairedTimer + 1u); /* ESCAN00016667 */
# endif
#endif
...
{
  /* ESCAN00085728: Forward callback to application */
  ApplNmBasicCanInit( CAN_CHANNEL_CANPARA_FIRST txHwObjectFirstUsed, txHwObjectFirstUnused );
...
{
  /* Notify application about the start of a message transmission */
  ApplNmBasicTxObjStart( CAN_CHANNEL_CANPARA_FIRST txHwObject );
...
{
  /* Notify application about successful message transmission */
  ApplNmBasicTxObjConfirmed( CAN_CHANNEL_CANPARA_FIRST txHwObject );
...
# if defined ( C_MULTIPLE_RECEIVE_CHANNEL )  /* ESCAN00016556 */
  /* Check if function was called for a NmBasic channel */
#  if defined ( NMBASIC_ENABLE_INDEXED_NM )
  if( channel < cNmBasicNrOfChannels )
#  else
...
#endif /* ( ( (defined NMBASIC_BUSOFF_RECOV_EXTENDED) && (defined NMBASIC_ENABLE_BUSOFFREP_MSG) ) || (defined NMBASIC_ENABLE_TX_OBSERVATION) ) */
...
# endif
  ...
  if( wNmBasicBusOffRecFastSlowTimer != 0u )
  {
    /* decrement the timer */
    wNmBasicBusOffRecFastSlowTimer--;
...
# if defined(NMBASIC_ENABLE_BUSOFFREP_TIMER)
  ...
  if( ( wNmBasicBusOffRepairedTimer != 0u )
#  if defined(NMBASIC_BUSOFF_RECOV_THREE_STEP)
  /* Do handle BusOffRepairedTimer if new BusOff has occured. 
   * BusOffRepairedTimer will be reset later in task when BusOff state is entered. */
    && ( bNmBasicStateRequest != NMBASIC_STATE_BUSOFF )
#  endif
    )
  {
    /* decrement the timer */
    wNmBasicBusOffRepairedTimer--;
...
#  if defined(NMBASIC_BUSOFF_RECOV_EXTENDED)
      ...
      /* wNmBasicBusOffRecTimer = 0; => not necessary because the BusOff recovery 
...
# endif
        ...
        NmBasicCanOnline(NMBASIC_CHANNEL_CANPARA_ONLY);
...
# endif
        ...
        wNmBasicBusOffRecTimer = (vuint16)cNmBasicBusOffRecTimer;
        ...
        if(bNmBasicBusOffRecSlowActive == cNmBasicBusOffSlowNotActive)
        {
          ...
          wNmBasicBusOffRecTimer = (vuint16)cNmBasicBusOffRecTimer; /* ESCAN00016667 */

            /* if it is the first BusOff ... */
            if( wNmBasicBusOffRecFastSlowTimer == 0u )
            {
              /* ... start the timer to detect the change from fast to slow recovery */
              wNmBasicBusOffRecFastSlowTimer = (vuint16)cNmBasicBusOffFastToSlowTimer; /* ESCAN00016667 */
            }
        }
        else
        {
          /* start BusOff recovery timer for slow recovery */
          wNmBasicBusOffRecTimer = (vuint16)cNmBasicBusOffRecSlowTimer; /* ESCAN00016667 */
...
#if defined NMBASIC_BUSOFF_RECOV_THREE_STEP
        if( bNmBasicBusOffImmediateToQuickCnt < cNmBasicBusOffImmediateToQuickCnt )
        {
          /* Do immediate recovery. */
          bNmBasicBusOffImmediateToQuickCnt++;
          wNmBasicBusOffRecTimer = (vuint16)cNmBasicBusOffRecImmediateTimer;
        }
        else if( bNmBasicBusOffQuickToSlowCnt < cNmBasicBusOffQuickToSlowCnt )
        {
          /* Do quick recovery. */
          bNmBasicBusOffQuickToSlowCnt++;
          wNmBasicBusOffRecTimer = (vuint16)cNmBasicBusOffRecTimer;
        }
        else
        {
          /* Do slow recovery. */
          wNmBasicBusOffRecTimer = (vuint16)cNmBasicBusOffRecSlowTimer;
        }

        /* Stop BusOff repair timer, if new BusOff occurred. */
        wNmBasicBusOffRepairedTimer = 0u;
...
#endif
      } /* bNmBasicBusOffRequest == NMBASIC_STATE_BUSOFF */
...
#if( defined(NMBASIC_BUSOFF_RECOV_DELAYED) || defined(NMBASIC_BUSOFF_RECOV_EXTENDED) \
     || defined(NMBASIC_BUSOFF_RECOV_TIME_SUPERVISED) || defined(NMBASIC_BUSOFF_RECOV_THREE_STEP) )
...
# if( defined ( NMBASIC_BUSOFF_RECOV_THREE_STEP ) && defined ( NMBASIC_ENABLE_BUSOFFREP_TIMER ) )
            /* Start BusOff repair timer for detection of successful BusOff recovery. */
            wNmBasicBusOffRepairedTimer = (vuint16)cNmBasicBusOffRepairedTimer;
# endif
...
/* module specific MISRA deviations:
   ...
   MD_NmBasic_3673:
      Reason:     API is defined by specification and can't be modified.
      Risk:       Developer is tempted to change the data where the pointer points to.
      Prevention: Assert during review that data is not changed.
 */

/**********************************************************************************************************************
  END OF FILE: nm_basic.c
**********************************************************************************************************************/
