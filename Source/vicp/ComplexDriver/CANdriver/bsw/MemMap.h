...
# undef VSTDLIB_START_SEC_CONST_UNSPECIFIED              /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define START_SEC_CONST_UNSPECIFIED                     /* mapped to default const section */
#endif
#ifdef VSTDLIB_STOP_SEC_CONST_UNSPECIFIED  
# undef VSTDLIB_STOP_SEC_CONST_UNSPECIFIED               /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define STOP_SEC_CONST
#endif

#ifdef VSTDLIB_START_SEC_VAR_NOINIT_UNSPECIFIED
# undef VSTDLIB_START_SEC_VAR_NOINIT_UNSPECIFIED         /* PRQA S 0841 */ /* MD_MSR_19.6 */
...
# undef VSTDLIB_STOP_SEC_VAR_NOINIT_UNSPECIFIED          /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define STOP_SEC_VAR 
#endif
