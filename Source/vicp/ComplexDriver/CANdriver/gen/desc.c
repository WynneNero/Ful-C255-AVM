...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             12362
...
V_MEMROM0 static V_MEMROM1 DescSvcHead V_MEMROM2 g_descSvcHead[kDescSvcHeadNumItems] = 
{
  ...
  { 0x07, 2, 2, 0x01, 0x01, 0, 1, 0, 0x00, 0x06, 0x00,  4, 16, 14 } /* $2E */, 
...
V_MEMROM0 static V_MEMROM1 DescSvcInst V_MEMROM2 g_descSvcInst[kDescSvcInstNumItems] = 
{
  ...
  {   7, { 0x01, 0x01, 0 }, { 0x02, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidProgramming_Date } /* $2E $F1 $99 */, 
  ...
  {   7, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidSystem_Configuration_1 } /* $2E $F1 $A1 */, 
  ...
  {   0, { 0x03, 0x03, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0, DescRoutineControlByIdentifier } /* $31 */, 
...
{
  { 0x0100,    2, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidVehicleSpeed }, 
  { 0x0101,    4, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidOdometer }, 
  { 0x0102,    1, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSupplyVoltage }, 
  { 0x2B00,    1, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidAVS_Calibration_Status }, 
  { 0x2B10,    1, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidAVS_View_change_status }, 
  ...
  { 0xF189,   15, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_ECU_Software_Version_Number }, 
  { 0xF190,   17, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_Vehicle_Identification_Number }, 
  { 0xF191,   15, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_ECU_Hardware_Version_Number }, 
  { 0xF192,   16, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSupplier_ECU_Hardware_Number }, 
  { 0xF193,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidSupplier_ECU_Hardware_Version_Number }, 
  { 0xF194,   16, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSupplier_ECU_Software_Number }, 
  ...
  { 0xF1A1,    4, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidSystem_Configuration_1 }, 
...
{
  0x0202, 0xE100, 0xE101, 0xFF00, 0xFF01
};
...
{
  { { 0x02, 0x02, 0x00 }, { 0x01, 0x01, 0 } } /* $0202 */, 
  { { 0x06, 0x02, 0x00 }, { 0x03, 0x03, 0 } } /* $e100 */, 
  { { 0x06, 0x02, 0x00 }, { 0x03, 0x03, 0 } } /* $e101 */, 
...
{
  {   7, { { 0x02, 0x02, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescRtnCtrlStartChecksum_Check } /* $31 $1 $2 $2 */, 
  {   3, { { 0x06, 0x02, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartEnter_EOL_view } /* $31 $1 $E1 $0 */, 
  {   3, { { 0x06, 0x02, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlReqResEnter_EOL_view } /* $31 $3 $E1 $0 */, 
  {   3, { { 0x06, 0x02, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartStart_calibration } /* $31 $1 $E1 $1 */, 
  {   3, { { 0x06, 0x02, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlReqResStart_calibration } /* $31 $3 $E1 $1 */, 
...
#endif
          {
            ...
            /* If necessary at each ECU reset - set the penality timer always */
				  ...
				  &&(g_descBuffer[0][0] == 0x2F))
				  {
				  	...
				  	if((g_descBuffer[0][0] == 0x27)
&& (g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.suppPosRes == 0x01)) //delete service 27 mask 0x80 by colin fix BUG2021102500030
				  	{
...
void DescSecurityGetAttCounter(void)    //add hongqi error key hard reset can't enter 27 sever in 60s
{
/* If necessary at each ECU reset - set the penality timer always */
...
#endif
    {
          	/*2021/07/17, don't move*/
//    	DiagDTC_27_KeyAwaited  = g_descIsKeyAwaited;
