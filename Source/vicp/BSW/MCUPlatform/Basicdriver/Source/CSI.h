...
*-----------------------------------------------------------------------
*     0.2     2016-9-22   ShangQiuju            remove ununsed data struct.
*-----------------------------------------------------------------------
*     0.3    2017-01-24    ZhangJie              Fix Coverity warning.
*-----------------------------------------------------------------------
*     0.4    2017-02-16     ShangQiuju        Update data and clock phase config.
*=====================================================================*/
#ifndef   _CSI_H_
#define   _CSI_H_
...
typedef enum
{
    E_SPI_MODE_0=0x00,/*CKR=0,DAP=0:default level of clock is high ;data can be capture in second edge of clock,rising edge */
    E_SPI_MODE_1=0x01,/*CKR=0,DAP=1:default level of clock is high ;data can be capture in first edge of clock,falling edge */
    E_SPI_MODE_2=0x02,/*CKR=1,DAP=0:default level of clock is low ;data can be capture in second edge of clock,falling edge */
    E_SPI_MODE_3=0x03,/*CKR=1,DAP=1:default level of clock is low ;data can be capture in first edge of clock,rising edge*/
}E_CLOCK_DATA_PHASE_TYPE;
/*
...
#define CSIG_CFG0_DAP_PHASE_0                   (0x00010000UL)  /*data can be capture in first edge of clock ,For CSIGn, polarity is low(CKR=0),then phase is falling-edge. polarity is high(CKR=1),then phase is rising-edge. */
#define CSIG_CFG0_DAP_PHASE_180               (0x00000000UL)  /*data can be capture in sencond edge of clock ,For CSIGn, polarity is low(CKR=0),then phase is rising-edge. polarity is high(CKR=1),then phase is falling-edge. */

/*Clock and Data Phase selection bit (CSIHnCFGx):CSIHnCKPx,CSIHnDAPx*/
#define CSIH_CFGx_CKP_DAP_0    (0x00000000UL)   /* clock default level is high ,data can be capture in second edge of clock,rising edge*/
#define CSIH_CFGx_CKP_DAP_1    (0x00010000UL)   /* clock default level is high ,data can be capture in first edge of clock,falling edge*/
#define CSIH_CFGx_CKP_DAP_2    (0x00020000UL)   /* clock default level is low ,data can be capture in second edge of clock,falling edge*/
#define CSIH_CFGx_CKP_DAP_3    (0x00030000UL)   /* clock default level is low ,data can be capture in first edge of clock,rising edge*/
...
/* Selects the initial level of the clock CSIHTSCK (CSIHnCKR) */
#define CSIH_CTL1_CKR_CLOCK_LEVEL_HIGH           (0x00000000UL)  /* Initial level of CSIGTSCK is high */
#define CSIH_CTL1_CKR_CLOCK_LEVEL_LOW            (0x00020000UL)  /* Initial level of CSIGTSCK is low */
...
#define  CSI_REG_CSIGnCFG0(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1010u))		/* different with CSIH*/
#define  CSI_REG_CSIGnTX0W(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1004u))
#define  CSI_REG_CSIGnTX0H(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x1008u))
#define  CSI_REG_CSIGnRX0(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x100Cu))
...
#define  CSI_REG_CSIHnCTL0(BaseAddress)   (*(CPU_REG08 *)((BaseAddress) + 0x0000u))
#define  CSI_REG_CSIHnCTL1(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x0010u))
#define  CSI_REG_CSIHnCTL2(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x0014u))
#define  CSI_REG_CSIHnSTR0(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x0004u))
#define  CSI_REG_CSIHnSTCR0(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x0008u))

#define  CSI_REG_CSIHnTX0W(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1008u))
#define  CSI_REG_CSIHnTX0H(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x100Cu))
#define  CSI_REG_CSIHnRX0W(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1010u))
#define  CSI_REG_CSIHnRX0H(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x1014u))

#define  CSI_REG_CSIHnMCTL0(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x1040u))
#define  CSI_REG_CSIHnMCTL1(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1000u))
#define  CSI_REG_CSIHnMCTL2(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1004u))
#define  CSI_REG_CSIHnMRWP0(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1018u))

#define  CSI_REG_CSIHnBRS0(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x1068u))
#define  CSI_REG_CSIHnBRS1(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x106Cu))
#define  CSI_REG_CSIHnBRS2(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x1070u))
#define  CSI_REG_CSIHnBRS3(BaseAddress)   (*(CPU_REG16 *)((BaseAddress) + 0x1074u))

#define  CSI_REG_CSIHnMRWP(BaseAddress)   (*(CPU_REG32 *)((BaseAddress) + 0x1018u))

/*css cfg address*/
#define  CSI_REG_CSIHnCFGx(BaseAddress,x)   (*(CPU_REG32 *)((BaseAddress) + 0x1044u+((x)*4u)))
