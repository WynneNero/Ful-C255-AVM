 ...
 * Mod. Date     : $Date: 2013/11/12 10:09:47MEZ $
...
typedef volatile struct R_FDL_REQUEST_T
{
    ...
    uint32_t            bufAddr_u32;        /**< Write operation: \n
                                                 Source data address */
    uint32_t            idx_u32;            /**< Write, blank check, read operation: \n
                                                 byte index (address) relative to DF start address\n
                                                 Erase operation: \n
