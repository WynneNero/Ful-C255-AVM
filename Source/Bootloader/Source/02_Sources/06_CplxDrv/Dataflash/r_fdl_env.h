 ...
 * Mod. Date     : $Date: 2013/10/21 17:24:45MESZ $
...
#define R_AUTH_BASE                   (0xFFA08000uL)

#define R_FCU_REGADD_AUTH_ID0_U32     (R_AUTH_BASE + 0x000uL)
#define R_FCU_REGADD_AUTH_ID1_U32     (R_AUTH_BASE + 0x004uL)
#define R_FCU_REGADD_AUTH_ID2_U32     (R_AUTH_BASE + 0x008uL)
#define R_FCU_REGADD_AUTH_ID3_U32     (R_AUTH_BASE + 0x00cuL)
#define R_FCU_REGADD_AUTH_STAT_U32    (R_AUTH_BASE + 0x010uL)
#define R_FCU_REGBIT_AUTH_STAT_LOCKED (0x00000001uL)


#define R_DECC_BASE_E1X                   (0xffc62c00uL)
#define R_DECC_BASE_F1X                   (0xffc66000uL)
#ifdef FDL_CFG_E1X_P1X_PLATFORM
    #define R_DECC_BASE                   R_DECC_BASE_E1X
#else
    #define R_DECC_BASE                   R_DECC_BASE_F1X
#endif

#define R_FCU_REGADD_DFERSTR_U08      (R_DECC_BASE + 0x004uL)
#define R_FCU_REGBIT_DFERSTR_SEDF     (0x01u)
#define R_FCU_REGBIT_DFERSTR_DEDF     (0x02u)
#define R_FCU_REGVAL_DFERSTR_NOERR    (0x00u)
...
#define R_FCU_REGADD_DFEADR_U32       (R_DECC_BASE + 0x018uL)
...
#define R_FDL_FCU_RAM_ADD_CHKSUM_END  (0xFFA12FF8uL)
#define R_FDL_FCU_RAM_ADD_CHKSUM      (0xFFA12FFCuL)
#define R_FDL_EXTRA3_FWVER            (0x00010219uL) 
#define R_FDL_EXTRA3_FMAX             (0x00010234uL)
#define R_FDL_EXTRA3_FMIN             (0x00010238uL)
#define R_FDL_EXTRA3_FDIV             (0x00010264uL)  
#define R_FDL_EXTRA3_FPCLK            (0x00010274uL)  
...
#define R_FDL_BLOCK_SIZE              (0x0040u)               /* EEP Flash block size in bytes */
#define R_FDL_BLOCK_SIZE_2N           (0x0006u)               /* EEP block size as 2^N Bytes */
#define R_FDL_WRITE_SIZE              (0x00000004uL)          /* Normal write granularity */
#define R_FDL_WRITE_SIZE_16B          (0x00000010uL)          /* 16 bytes write granularity */
#define R_FDL_MACROSIZE_MIN           (0x00001000uL)          /* Minimum Flash macro size */
