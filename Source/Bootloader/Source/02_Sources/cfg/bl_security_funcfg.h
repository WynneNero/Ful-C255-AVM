...
/** \brief If the input data needs to be reflected*/
#define SECM_CRC_INPUT_REFLECTED    BL_FUN_ON
/** \brief If the result data needs to be reflected*/
#define SECM_CRC_RESULT_REFLECTED   BL_FUN_ON
#endif
