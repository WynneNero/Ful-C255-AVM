...
************************************************************************************************
END_FUNCTION_HDR*/
bl_Return_t OverTimeCheckLong(volatile bl_u32_t *pChkByte, bl_u32_t ChkBitsMask, bl_u32_t ChkVal, bl_u16_t ChkTime)
{
    ...
    {
        ChkTime--;
        //SBCWatchdogTrigger(); /* Feed Watchdog */
    }
    
    if(ChkTime == 0)
    {
        ret = BL_ERR_NOT_OK;      /* Overtime occur     */
    }
    else
    {
        ret = BL_ERR_OK;  /* Overtime not occur */
    }
