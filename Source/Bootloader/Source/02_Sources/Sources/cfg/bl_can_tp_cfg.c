 ...
 *****************************************************************************/
#define CANTP_MAKE_TIMEOUT(ms)  ((bl_u16_t)((ms)/CANTP_SCHEDULE_PERIOD))
/*****************************************************************************
...
const bl_CanTpChannelCfg_t g_CanTpRxChnsCfg[CANTP_NUMBER_OF_RX_CHANNEL] =
{
    /*Channel 0:Phsical & Standars addressing*/
    {
        ...
        0,  /* RX HANDLE */
        0,  /* TX HANDLE */
        CANTP_MAKE_TIMEOUT(70),     /* TIME A *//*For JAC by liya.zhu*/
        CANTP_MAKE_TIMEOUT(70),     /* TIME B *//*For JAC by liya.zhu*/
        CANTP_MAKE_TIMEOUT(150),    /* TIME C */
        0,  /* TA */
        0,  /* STmin */
        0,  /* BS */
        0,  /* WFT */
    ...
    /*Channel 1:functional & Standars addressing*/
    {
        ...
        1,  /* RX HANDLE */
        0,  /* TX HANDLE */
        CANTP_MAKE_TIMEOUT(70),     /* TIME A */
        CANTP_MAKE_TIMEOUT(70),     /* TIME B */
        CANTP_MAKE_TIMEOUT(150),    /* TIME C */
        0,  /* TA */
        0,  /* STmin */
        0,  /* BS */
...
const bl_CanTpChannelCfg_t g_CanTpTxChnsCfg[CANTP_NUMBER_OF_TX_CHANNEL] =
{
    /*Channel 0:Phsical & Standars addressing*/
    {
        ...
        0,  /* TX HANDLE */
        CANTP_MAKE_TIMEOUT(70),     /* TIME A */
        CANTP_MAKE_TIMEOUT(150),    /* TIME B */
        CANTP_MAKE_TIMEOUT(70),     /* TIME C */
        0,  /* TA */
        0,  /* STmin */
        0,  /* BS */
        0,  /* WFT */
